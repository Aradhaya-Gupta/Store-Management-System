...
void Customer()
{
    ...
    {
        system("cls");
        file=fopen("aradhaya.txt","a");
        gotoxy(22,20);
        printf("ADD CUSTOMER");
        gotoxy(22,22);
        printf("Enter id(h.no): ");
        scanf("%d",&cust.code);
        gotoxy(22,23);
        printf("Enter Name:");
        scanf("%s",&cust.name);
    ...
    if(flag==0)
    {
        file1=fopen("aradhaya1.txt","a");
        file=fopen("aradhaya.txt","r");
        rewind(file);
        ...
        remove("aradhaya.txt");
        rename("aradhaya1.txt","aradhaya.txt");
    }
    if (flag==1)
    {
        gotoxy(25,29);
