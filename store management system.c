...
void no_of_days(int,int,int,int,int,int,int,int);
...
/*void no_of_days(int a1,int a2,int b1,int b2,int c1,int c2)
{

  time_t t = time(NULL);
  struct tm tm = *localtime(&t);
  c2=tm.tm_year + 1900; b2=tm.tm_mon + 1; a2=tm.tm_mday;
